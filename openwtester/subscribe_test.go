...
func TestSubscribeAddress(t *testing.T) {
	...
	var (
		...
		addrs      = map[string]string{
			//"16pszy4tx63zj9t9s5bapqh6vb91pvp0w0vtzj3xg6e0896sevd2mxf84": "sender",
			"11hdxdzd82h01esjb4th7963db2fwf90rp8cxjk5jsrgvjdf2rnx5tges": "reciver",
		}
	)
	...
	scanner.SetRescanBlockHeight(17)
