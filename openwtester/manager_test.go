...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO BBC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W8RQxn7jwujGNjshJ6qWWZR9aK2TMjWAhJ")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W8RQxn7jwujGNjshJ6qWWZR9aK2TMjWAhJ"

	account := &openwallet.AssetsAccount{Alias: "BBC", WalletID: walletID, Required: 1, Symbol: "BBC", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	tm := testInitWalletManager()
	walletID := "W8RQxn7jwujGNjshJ6qWWZR9aK2TMjWAhJ"
	accountID := "8ZozeRdTbmaWCE6dNCp9zyGjY5yaPb5cv6NV7hWfEKBo"
